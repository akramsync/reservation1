<?php
$ticket_type = "VIP Seated"; // défini en dur selon la page
?>
        ...
        <form action="process_booking.php" method="POST">
            ...
            <div class="champ">
                ...
                <select id="ticket_type" name="ticket_type">
                    <option value="VIP Seated" selected>VIP Seated</option>
                   
                </select>
                <div class="type-billet">
                    <p><strong>VIP Seated</strong> grants access to all general areas of the event..</p>
                </div>
            </div>
