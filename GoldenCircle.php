<?php
$ticket_type = "Golden Circle"; // défini en dur selon la page
?>
        ...
        <form action="process_booking.php" method="POST">
            ...
            <div class="champ">
                ...
                <select id="ticket_type" name="ticket_type">
                    <option value="Golden Circle" selected>Golden Circle</option>
                   
                </select>
                <div class="type-billet">
                    <p><strong>Golden Circle</strong> grants access to all general areas of the event.</p>
                </div>
            </div>
